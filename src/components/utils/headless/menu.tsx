...
import { BlockOutlined, DownOutlined, EditOutlined, MoreOutlined } from '@ant-design/icons'

export const MenuHeadless = () => {
  return (
    <div className="">
        ...
        <div>
          <Menu.Button className="inline-flex items-center rounded-md border border-transparent bg-indigo-600 px-4 py-2 text-sm font-medium text-white shadow-sm hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2">
            ...
            {/* <ChevronDownIcon
              ...
              aria-hidden="true"
            /> */}
            <MoreOutlined className="ml-2 -mr-1 h-5 w-5 text-indigo-200 hover:text-indigo-100" style={{ fontSize: '20px' }} />
            {/* <DownOutlined className="ml-2 -mr-1 h-5 w-5 text-indigo-200 hover:text-indigo-100"/> */}
          </Menu.Button>
        </div>
        <Transition
          as={Fragment}
            ...
            <div className="px-1 py-1 ">
              <Menu.Item>
                {({ active }) => (
                  ...
                  >
                    <EditOutlined className="mr-2 h-5 w-5 text-indigo-400" style={{ fontSize: '20px' }}/>
                    Edit
                  </button>
                )}
              </Menu.Item>
              <Menu.Item>
                {({ active }) => (
                  ...
                  >
                    <BlockOutlined className="mr-2 h-5 w-5 text-indigo-400" style={{ fontSize: '20px' }} />
                    Duplicate
                  </button>
                )}
              </Menu.Item>
