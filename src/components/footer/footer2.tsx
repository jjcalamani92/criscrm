export const Footer2 = () => {
  return (
    <footer>
        <div className="pt-8 bg-gradient-to-b from-gray-900 to-sky-900 md:pt-20">
          <div className="container m-auto px-6 space-y-8 text-gray-400 md:px-12 lg:px-20">
            <div>
              <div className="mb-6 gap-6 items-center justify-between py-6 sm:flex md:mb-16 md:py-0 md:space-y-6">
                <img width={100} height={42} src="https://tailus.io/images/logo.svg" alt="logo tailus" className="w-32" />
                <div className="flex flex-wrap flex-col-reverse gap-6 mt-6 sm:flex-row sm:mt-0 sm:items-center">
                  <select name="langage" id="langae" className="px-4 py-2 w-full rounded-xl bg-gray-900 sm:w-max">
                    <option value="en">English</option>
                    <option value="fr">French</option>
                    <option value="sw">Swahili</option>
                  </select>
                  <div className="flex gap-6">
                    <a href="#" target="blank" aria-label="github" className="hover:text-cyan-400">
                    ...
                    <a href="#" target="blank" aria-label="twitter" className="hover:text-cyan-400">
                      <svg xmlns="http://www.w3.org/2000/svg" width={20} height={20} fill="currentColor" className="bi bi-twitter" viewBox="0 0 16 16">
                        <path d="M5.026 15c6.038 0 9.341-5.003 9.341-9.334 0-.14 0-.282-.006-.422A6.685 6.685 0 0 0 16 3.542a6.658 6.658 0 0 1-1.889.518 3.301 3.301 0 0 0 1.447-1.817 6.533 6.533 0 0 1-2.087.793A3.286 3.286 0 0 0 7.875 6.03a9.325 9.325 0 0 1-6.767-3.429 3.289 3.289 0 0 0 1.018 4.382A3.323 3.323 0 0 1 .64 6.575v.045a3.288 3.288 0 0 0 2.632 3.218 3.203 3.203 0 0 1-.865.115 3.23 3.23 0 0 1-.614-.057 3.283 3.283 0 0 0 3.067 2.277A6.588 6.588 0 0 1 .78 13.58a6.32 6.32 0 0 1-.78-.045A9.344 9.344 0 0 0 5.026 15z" />
                      </svg>
                    </a>
                    <a href="#" target="blank" aria-label="medium" className="hover:text-cyan-400">
              ...
              <div>
                <div className="pb-16 grid grid-cols-2 gap-6 sm:grid-cols-3 md:grid-cols-5">
                  ...
                  <div className="col-span-2 sm:col-span-3 md:col-span-2">
                    ...
                    <ul className="list-inside mt-4 space-y-4">
                      <li>
                        <a href="tel:+243996660436" className="hover:text-cyan-400 transition">+243 996 660 436</a>
                      </li>
                      <li>
                        <a href="mailto:meschacirung@gmail.com" className="hover:text-cyan-400 transition">contact@tailus.com</a>
                      </li>
                      <li>
                        <form>
                ...
                <div className="py-8 border-t border-cyan-800 text-gray-200 flex justify-between">
                  <span>© tailus 2003 - <span id="year" /></span>
