  ...
  return (
    <footer>
        <svg xmlns="http://www.w3.org/2000/svg" className="w-full -mb-0.5" viewBox="0 0 1367.743 181.155">
          <path className="fill-current text-gray-200" id="wave" data-name="wave" d="M0,0S166.91-56.211,405.877-49.5,715.838,14.48,955.869,26.854,1366,0,1366,0V115H0Z" transform="translate(1.743 66.155)" />
        </svg>
            ...
            <div className="grid grid-cols-8 gap-6 md:gap-0">
              <div className="border-r col-span-8 md:col-span-2 lg:col-span-3">
                <div className="flex gap-6 items-center justify-between py-6 border-b border-white md:py-0 md:border-none md:block md:space-y-6">
                  <img src="https://tailus.io/images/logo.svg" alt="logo tailus" width={100} height={42} className="w-32" />
