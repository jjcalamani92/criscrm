  ...
  return (
    <footer className="bg-gray-100 rounded-xl">
        <div className="container m-auto px-6 py-16 space-y-8 text-gray-600 md:px-12 lg:px-20">
          <div className="flex flex-wrap gap-4 items-center justify-between pb-8 border-b">
            <img width={100} height={42} src="https://meschacirung.github.io/tailus-blocks/public/images/logo.svg" alt="logo tailus" className="w-32" />
